                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="z-10">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a className="px-8 py-4 bg-primary text-on-primary rounded-xl font-bold text-lg hover:opacity-90 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2" href="#menu">
                                Browse the Menu
            ...
            <section className="py-24 px-8 bg-surface-container-low" id="menu">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-12">
                        ...
                        <button onClick={() => setActiveTab('mochi')} className={`px-6 py-2 rounded-full ${activeTab === 'mochi' ? 'bg-primary text-on-primary' : 'bg-surface-container text-on-surface-variant hover:bg-primary-container'} transition-colors font-medium`}>Donuts Mochi</button>
